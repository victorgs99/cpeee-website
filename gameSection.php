<?php
    ...
    if(isset($_GET['Keyword'])){
        ...
        $evidencias = $cad->ObtieneTodasLasEvidenciasPorSeccion('Videojuego e Interacción');
    }
?>
...
<html lang="es">
    <head>
        ...
        <title>CPEEE - Videojuego e interacción</title>
    </head>
    <body>
        <div class="PageContainer">
            ...
            <div class="HeaderImg">
                <img src="img/gameHeader.png" alt="Encabezado CPEEE">
            </div>
                ...
                <div id="SideBarContent">
                    ...
                    <div class="WebSiteDescription">
                        <div class="DescriptionTitle">
                            <span>SOBRE LA SECCIÓN</span>
                        </div>
                        <div class="DescriptionImg">
                            <img src="img/gameDescription.gif" alt="Imagen de la descripción" title="Que el papel no quede en blanco">
                        </div>
                        <div class="Description">
                            <p>En esta sección encontraras evidencias de proyectos escolares
                                enfocados en creación y desarrollo de videojuegos; asi como realización 
                                de modelado 3D.
                            </p>
                        </div>
                    </div>
                    <div class="CommentsContainer">
                        <div class="CommentsTitle">
                            <span>Comentarios de la sección</span>
                        </div>
                        <div class="Comments">
                            <div class="Comment">
