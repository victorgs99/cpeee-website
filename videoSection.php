<?php
    ...
    if(isset($_GET['Keyword'])){
        ...
        $evidencias = $cad->ObtieneTodasLasEvidenciasPorSeccion('Video y Cortometraje');
    }
?>
...
<html lang="es">
    <head>
        ...
        <title>CPEEE - Video y cortometraje</title>
    </head>
    <body>
        <div class="PageContainer">
            ...
            <div class="HeaderImg">
                <img src="img/videoHeader.png" alt="Encabezado CPEEE">
            </div>
                ...
                <div id="SideBarContent">
                    ...
                    <div class="WebSiteDescription">
                        ...
                        <div class="DescriptionImg">
                            <img src="img/videoDescription.gif" alt="Imagen de la descripción" title="Que el papel no quede en blanco">
                        </div>
                        <div class="Description">
                            <p>En esta sección encontraras evidencias de proyectos escolares
                                enfocados en creación o edición de video; asi como realización 
                                de cortometrajes.
                            </p>
                        </div>
                    </div>
