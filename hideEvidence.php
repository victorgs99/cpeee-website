<?php
    ...
    if(isset($_GET['idEvidencia']) && isset($_GET['operacion'])){
        ...
        if($_GET['operacion'] == 'hide'){
            if($cad->OcultaEvidencia($_GET['idEvidencia'])){
                $band = 'H';
                $bandOp = true;
            }
        }else{
            if($cad->MuestraEvidencia($_GET['idEvidencia'])){
                $band = 'S';
                $bandOp = true;
            }
        }        
        ...
        <div class="PageContainer">
            ...
            <div class="PanelContainer">
                <div id="PrincipalPanel">
                    <div class="OperationPanelTitle"><span>Mostrar / Ocultar evidencia</span></div>
                    <div class="OperationPanel">
                        <div>
                            <span class="LabelOne">Selecciona la evidencia a mostrar / ocultar</span>
                        </div>
                            ...
                            <?php
                                ...
                                if($datos){
                                    ...
                                    foreach($datos as $registro){
                                        ...
                                        if($registro['estado_esvisible']){
                                            echo "<td><a href='hideEvidence.php?idEvidencia=$idEvidencia&operacion=hide'>Ocultar</a></td>";
                                        }else{
                                            echo "<td><a href='hideEvidence.php?idEvidencia=$idEvidencia&operacion=show'>Mostrar</a></td>";
                                        }
                                        echo "</tr>";
                                    }
