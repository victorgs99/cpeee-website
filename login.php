...
<html lang="es">
    <head>
        ...
        <title>CPEEE - Inicia sesión</title>
    </head>
    <body>
        <div class="PageContainer">
            ...
            <div class="TopBar">
                ...
                <div id="RightContent">
                    <a class="SignUpButton" href="signUp.php"><span>Sign Up</span></a>
                </div>
            </div>
            ...
            <div id="LoginContainer">
                <div class="LoginPanel">
                    <div class="TitleLogIn"><span>Inicio de sesión</span></div>
                    <form class="LoginForm" action="validateUser.php" method="post">
                        <div class="FormField">
