<?php
    ...
    if(isset($_GET['idEvidencia'])){
        $band = false;
        if($cad->EliminaEvidencia($_GET['idEvidencia'])){
            $band = true;
        }
    }
...
<html lang="es">
    <head>
        ...
        <link href="css/deleteEvidence.css" rel="stylesheet" type="text/css">
        <link href="css/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet">
        <title>CPEEE - Elimina evidencia</title>
    </head>
    <body>
        <div class="PageContainer">
            ...
            <div class="PanelContainer">
                <div id="PrincipalPanel">
                    <div class="OperationPanelTitle"><span>Eliminación de evidencia</span></div>
                    <div class="OperationPanel">
                        <div>
                            <span class="LabelOne">Selecciona la evidencia a eliminar</span>
                            <br>
                            <span class="LabelTwo">(Esta operación es irreversible)</span>
                        </div>
                            ...
                            <?php
                                ...
                                if($datos){
                                    ...
                                    foreach($datos as $registro){
                                        ...
                                        echo "<td><a href='deleteEvidence.php?idEvidencia=$idEvidencia'>Eliminar</a></td>";
                                        echo "</tr>";
                                    }
                    ...
                    <div class="PanelMessage">
                        ...
                        <div class="Message">
                            <?php
                                if(isset($_GET['idEvidencia'])){
                                    if($band){
                                        echo "<span>La evidencia ha sido eliminada</span>";
                                    }else{
                                        echo "<span>La evidencia no pudo ser eliminada</span>";
                                    }
                                    //session_destroy();
                                }else{
