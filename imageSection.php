<?php
    ...
    if(isset($_GET['Keyword'])){
        ...
        $evidencias = $cad->ObtieneTodasLasEvidenciasPorSeccion('Imagen e Ilustración');
    }
?>
...
<html lang="es">
    <head>
        ...
        <title>CPEEE - Imagen e ilustración</title>
    </head>
    <body>
        <div class="PageContainer">
            ...
            <div class="HeaderImg">
                <img src="img/photoHeader.png" alt="Encabezado CPEEE">
            </div>
                ...
                <div id="SideBarContent">
                    ...
                    <div class="WebSiteDescription">
                        ...
                        <div class="DescriptionImg">
                            <img src="img/photoDescription.jpg" alt="Imagen de la descripción" title="Que el papel no quede en blanco">
                        </div>
                        <div class="Description">
                            <p>En esta sección encontraras evidencias de proyectos escolares
                                enfocados en creación o edición de imagenes; asi como ilustraciones.
                            </p>
                        </div>
                    </div>
