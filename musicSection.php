<?php
    ...
    if(isset($_GET['Keyword'])){
        ...
        $evidencias = $cad->ObtieneTodasLasEvidenciasPorSeccion('Audio y Música');
    }
?>
...
<html lang="es">
    <head>
        ...
        <title>CPEEE - Audio y música</title>
    </head>
    <body>
        <div class="PageContainer">
            ...
            <div class="HeaderImg">
                <img src="img/musicHeader.png" alt="Encabezado CPEEE">
            </div>
                ...
                <div id="SideBarContent">
                    ...
                    <div class="WebSiteDescription">
                        ...
                        <div class="DescriptionImg">
                            <img src="img/musicDescription.gif" alt="Imagen de la descripción" title="Que el papel no quede en blanco">
                        </div>
                        <div class="Description">
                            <p>En esta sección encontraras evidencias de proyectos escolares
                                enfocados en creación o edición de clips de audio; asi como realización 
                                de pistas musicales.
                            </p>
                        </div>
                    </div>
