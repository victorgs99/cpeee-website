<?php
    ...
    if(isset($_GET['idUsuario'])){
        $evidencias = $cad->ObtieneTodasLasEvidenciasDeUsuario($_GET['idUsuario']);
...
<html lang="es">
    <head>
        ...
        <?php echo "<title>$datosUsuario[1]</title>";?>
    </head>
    <body>
                ...
                <div id="PrincipalContent">
                    ...
                    <?php
                        ...
                        foreach($evidencias as $evidencia){
                            ...
                            $archivos = $cad->ObtieneArchivosEvidenciaUsuario($_GET['idUsuario'], $idEvidenciaAux);
                            $band = true;
                    ...
                    <!--<div class="EvidenceContent">
                        <div class="EvidenceImg"><a class="EvidenceLink" href=""><img src="img/indexEvidence.gif" alt="Imagen de la descripción"></a></div>
                        <div class="EvidenceData">
                            <div class="EvidenceTitle"><a href=""><span>Título de la evidencia Título de la evidencia</span></a></div>
                            <div class="EvidenceDescription"><p>Lorem</p></div>
                        </div>
                    </div>-->
                </div>
